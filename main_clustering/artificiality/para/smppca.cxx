...
int main(void){
  ...
  Smppca test(data_dimension, data_number, centers_number,
              sub_dimension, Em);
#ifdef VERBOSE
  ...
  Smppca ClassFunction(test.dimension(), 1, test.centers_number(),
                       1, test.fuzzifierEm()) ;
